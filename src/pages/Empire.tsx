    ...
    <ReleasePage data={data}>
      ...
      <p>
        ...
        <i>
          ...
          debut EP. We sat down one saturday, filled our coffee cups and after a
          few hours, we had the 10 minute demo ready. When writing, we usually
          just add cool, over-the-top stuff until the song seems finished to
          us."
        </i>
      </p>
    </ReleasePage>
