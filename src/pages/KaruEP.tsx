  ...
  return (
    <ReleasePage data={data}>
      ...
      <p>
        ...
        <i>
          "We originally had four songs, with one of them not making the cut to
          the EP and I remember sitting with Kalle (Pöyskö) in my apartment and
          going 'we need a crazy metal song for this album' and that night, my
          favourite KARU song 'Nemesis' was born. Lyrically 'Nemesis' tells the
          story of a witch hunter seeking a daemon who has possessed someone in
          a village."
        </i>
      </p>
    </ReleasePage>
